...
function BoardList({ apiEndpoint = '/board', title = '게시판', detailPathPrefix = '/board' }) {
    ...
    const fetchPosts = useCallback((page) => {
        setLoading(true);
        console.log(`API 요청: ${normalizedApiEndpoint}?page=${page}&size=${pageSize}`);
        ...
        <div className="board-container">
            ...
            {loading ? (
                ...
                <div className="error-container">
                    ...
                    <button className="retry-button" onClick={() => fetchPosts(currentPage)}>다시 시도</button>
                </div>
                ...
                <div className="board-list">
                    {safePostsArray.map(post => (
                        <div key={post.id || `post-${Math.random()}`} className="post-item" onClick={() => post.id && handlePostClick(post.id)}>
                            ...
                            <div className="post-contents">
                                ...
                                <div className="post-footer">
                                    <span className="post-author">{post.name || '작성자 없음'}</span>
