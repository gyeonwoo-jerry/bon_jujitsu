...
function Academy() {
  ...
  const renderAcademyContent = () => (
      <>
        ...
        <h3>본주짓수 프로그램</h3>
        <p>
          2023년 현재 50개 지역에서 80여 명의 지도자들이 하루 평균 3,000명 이상의 학생들에게 특별한 경험을 전달하며 올바른
          도장으로
  ...
  const renderLevelContent = () => (
      <>
        ...
        <p>
          <strong className="white-belt">화이트벨트</strong><br/>
        ...
        <p>
          <strong className="blue-belt">블루벨트</strong><br/>
